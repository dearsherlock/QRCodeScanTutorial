...
public final class EncoderActivity extends Activity {
    ...
    private void GenBitMapQRCode(){
        ...
        try {
            ...
            // smallerDimension);
            EditText contents = (EditText) findViewById(R.id.contents_text_viewText);
            qrCodeEncoder = new QRCodeEncoder(contents.getEditableText().toString(), null, Contents.Type.TEXT, BarcodeFormat.QR_CODE.toString(), smallerDimension);
            ...
            //EditText contents = (EditText) findViewById(R.id.contents_text_view);
